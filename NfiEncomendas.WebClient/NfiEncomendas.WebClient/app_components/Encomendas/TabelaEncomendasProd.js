...
app.controller('tabelaEncomendasProdCtrl', ['$scope', '$rootScope', '$filter', '$http', 'toaster',
    function ($scope, $rootScope, $filter, $http, toaster) {
        ...
        $scope.submit = function () {
            $http.post(serviceBase + "api/Encomendas/PesquisaEncomendaProd/?pesqParam=", $scope.paramsPesquisa)
                .success(function (data, status, headers, config) {
