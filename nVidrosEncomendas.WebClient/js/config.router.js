        ...
        ['$stateProvider', '$urlRouterProvider',
            function ($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                    ...
                    .state('app.vidrosExtra', {
                        url: '/vidrosExtra',
                        template: '<div ui-view class=""></div>'
                    })
                    .state('app.vidrosExtra.tabela', {
                        url: '/tabela',
                        templateUrl: 'app_components/vidrosExtra/Tabela.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['app_components/vidrosExtra/Tabela.js']);
                                }]
                        }
                    })
                    .state('app.vidrosExtra.edit', {
                        url: '/edit/:id',
                        templateUrl: 'app_components/VidrosExtra/Edit.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['app_components/VidrosExtra/Edit.js']);
                                }]
                        }
                    })
                            ...
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(
                                        [
                                            'app_components/Dashboard/table/encomendasDashboardTable.js',
                                            'app_components/Dashboard/dashboard.js']);
                                }]
                        }
                    })
