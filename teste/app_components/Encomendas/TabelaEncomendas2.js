...
app.controller('tabela2EncomendasCtrl', ['$scope','$rootScope', '$filter', '$http', 'toaster',
function ($scope, $rootScope, $filter, $http, toaster) {
    ...
    $scope.submit = function () {
        $http.post(serviceBase + "api/Encomendas/PesquisaEncomendaRes/?pesqParam=", $scope.paramsPesquisa)
            .success(function (data, status, headers, config) {
                console.log(data);
            ...
            $scope.paramsPesquisa.agruparCliente = $scope.paramsPesquisa.ordenacao == 3 || $scope.paramsPesquisa.ordenacao == 5;
    ...
    $scope.addSetor = function () {
        ...
        //console.log($scope.paramsPesquisa.setorEncomenda);//, $scope.paramsPesquisa.tipoEncomenda, $scope.tiposEncomendaLista);
