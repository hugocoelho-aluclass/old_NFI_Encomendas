...
app.controller('recolhasTabelaCtrl', ['$scope', '$rootScope', '$state', '$filter', '$http', 'toaster', 'SavGlobalService',
    function ($scope, $rootScope, $state, $filter, $http, toaster, SavGlobalService) {
    // blockUI.start();
    ...
    $scope.paramsPesquisa.ordenacao = 19;
    $scope.pesqRes = {};
    $scope.pesqRes.savs = [];
