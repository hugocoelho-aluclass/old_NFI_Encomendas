...
namespace NfiEncomendas.WebServer.BusinessLogic
{
    public class SavsBL
    {
        ...
        {
            return DbContext.Savs.Include("Cliente").Where(x => x.Anulada == false).OrderBy(x => x.Id);
        ...
        public void CheckSerie()
        {
            ...
            if (existemSavsSemSerie)
            {
                ...
                var savsSemSerie = this.DbContext.Savs.Include("SerieDoc").Where(x => x.SerieDoc == null).OrderBy(x => x.CriadoData).ToList();
        ...
        public NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.PagSavPesquisaRes PesqParamRes(NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.PagSavPesquisaParam pesqParams)
        {
            CheckSerie();
            ...
            List<NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.SavsLinha2> resLista = Mapper.Map<List<Models.Savs>, List<NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.SavsLinha2>>(encs.ToList());


            List<NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.SavsLinha2> aRemover = new List<NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.SavsLinha2>();
            ...
            NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.PagSavPesquisaRes res = new NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.PagSavPesquisaRes();
            res.Savs = resLista;
            ...
            else if (pesqParams.OrdemPesquisa == 12) //agrupar cliente
            {
                ...
                for (int i = 0; i < listaCountFixo; i++)
                {
                    ...
                    {
                        res.Savs.Add(new NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.SavsLinha2()
                        {
