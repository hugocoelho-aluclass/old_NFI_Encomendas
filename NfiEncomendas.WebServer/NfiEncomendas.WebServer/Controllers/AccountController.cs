...
using NfiEncomendas.WebServer.Results;
using System;
...
namespace NfiEncomendas.WebServer.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> RegisterExternal(NfiEncomendas.WebServer.Models.ExternalLoginModels.RegisterExternalBindingModel model)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        private async Task<NfiEncomendas.WebServer.Models.ExternalLoginModels.ParsedExternalAccessToken> VerifyExternalAccessToken(string provider, string accessToken)
        {
            NfiEncomendas.WebServer.Models.ExternalLoginModels.ParsedExternalAccessToken parsedToken = null;
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                parsedToken = new NfiEncomendas.WebServer.Models.ExternalLoginModels.ParsedExternalAccessToken();
