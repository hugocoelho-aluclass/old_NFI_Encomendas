...
namespace Codaxy.WkHtmlToPdf
{
    ...
    public class PdfConvert
    {
            ...
            get
            {
                if (_e == null)
                    _e = new PdfConvertEnvironment
                    {
                        ...
                        WkHtmlToPdfPath = Path.Combine(
                        HttpContext.Current.Server.MapPath(@"~\apps\"), @"wkhtmltopdf\wkhtmltopdf.exe"),
                        Timeout = 60000
                    };
                return _e;
            }
        ...
        public static void ConvertHtmlToPdf(PdfDocument document, PdfOutput output, bool landscape = false)
        {
            ConvertHtmlToPdf(document, null, output, landscape);
        }


        public static string passo = "0";
        public static void ConvertHtmlToPdf(PdfDocument document, PdfConvertEnvironment environment, PdfOutput woutput, bool landscape = false)
        {
            passo = "0";
            if (environment == null)
