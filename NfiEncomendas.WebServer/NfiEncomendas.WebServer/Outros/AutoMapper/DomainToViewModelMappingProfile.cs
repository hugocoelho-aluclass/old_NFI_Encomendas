using AutoMapper;
using NfiEncomendas.WebServer.Areas.POS.ViewModels.Recolhas;
using System;
...
namespace NfiEncomendas.WebServer.Outros.AutoMapper
{
    public class DomainToViewModelMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            Mapper.CreateMap<Models.Clientes, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNome>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeCliente))
            .ForMember(x => x.Id, o => o.MapFrom(u => u.NumCliente));

            //IEnumerable<Models.EstadoSav>, IEnumerable<IdNome>
            Mapper.CreateMap<Models.EstadoRecolha, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNome>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeEstado))
            .ForMember(x => x.Id, o => o.MapFrom(u => u.Id));


            Mapper.CreateMap<Models.EstadoSav, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNome>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeEstadoSav))
            .ForMember(x => x.Id, o => o.MapFrom(u => u.IdEstadoSav));

            Mapper.CreateMap<Models.EstadoSav, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNomePreSelect>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeEstadoSav))
            .ForMember(x => x.Id, o => o.MapFrom(u => u.IdEstadoSav))
            .ForMember(x => x.PreSeleccionado, o => o.MapFrom(u => u.PreSeleccionadoNaPesquisa));

            Mapper.CreateMap<Models.TipoAvarias, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNome>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeTipoAvaria))
            .ForMember(x => x.Id, o => o.MapFrom(u => u.NumTipoAvaria));

            Mapper.CreateMap<Models.TipoAvarias, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNomeExtra>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeTipoAvaria))
            .ForMember(x => x.Id, o => o.MapFrom(u => u.NumTipoAvaria))
            .ForMember(x => x.Extra, o => o.MapFrom(u => u.InfoExtra));

            Mapper.CreateMap<Models.ProdutoSav, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNome>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeProdutoSav))
            .ForMember(x => x.Id, o => o.MapFrom(u => u.NumProdutoSav));

            Mapper.CreateMap<Models.DepartamentoSav, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNome>()
            ...
            Mapper.CreateMap<Models.Savs, NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.SavGet>()
            ...
            Mapper.CreateMap<Models.Savs, NfiEncomendas.WebServer.Areas.POS.ViewModels.Savs.SavsLinha2>()
            ...
            Mapper.CreateMap<Models.Anexos, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNome>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeFicheiro))
            .ForMember(x => x.Id, o => o.MapFrom(u => u.Id));

            Mapper.CreateMap<Models.EstadoRecolha, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNomeText>()
            .ForMember(x => x.Nome, o => o.MapFrom(u => u.NomeEstado))
            ...
            Mapper.CreateMap<Models.Setor, NfiEncomendas.WebServer.Areas.POS.ViewModels.IdNome>()
                    .ForMember(x => x.Nome, o => o.MapFrom(u => u.Nome))
                    .ForMember(x => x.Id, o => o.MapFrom(u => u.IdSetor));

            Mapper.CreateMap<Models.Setor, NfiEncomendas.WebServer.Areas.POS.ViewModels.Setores.Setor>()
                     .ForMember(x => x.Nome, o => o.MapFrom(u => u.Nome))
                     .ForMember(x => x.Id, o => o.MapFrom(u => u.IdSetor));
