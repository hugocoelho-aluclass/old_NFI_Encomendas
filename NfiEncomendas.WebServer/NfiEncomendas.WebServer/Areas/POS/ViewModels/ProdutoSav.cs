namespace NfiEncomendas.WebServer.Areas.POS.ViewModels.ProdutoSavs
{
    public class ProdutoSav
    {
        ...
        {
            Models.ProdutoSav res = (new NfiEncomendas.WebServer.BusinessLogic.ProdutoSavsBL()).LerProdutoSav(this.NumProdutoSav); //new Models.Operadores();
