namespace NfiEncomendas.WebServer.Areas.POS.ViewModels.Clientes
{
    public class Cliente
    {
        ...
        {
            Models.Clientes res = (new NfiEncomendas.WebServer.BusinessLogic.ClientesBL()).LerCliente(this.NumCliente); //new Models.Operadores();
