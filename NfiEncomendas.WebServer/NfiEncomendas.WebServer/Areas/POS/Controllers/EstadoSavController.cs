...
namespace NfiEncomendas.WebServer.Areas.POS.Controllers
{
    ...
    {
        [HttpGet]
        public List<NfiEncomendas.WebServer.Areas.POS.ViewModels.EstadoSav.EstadoSav> TabelaEstadoSav()
        {
        ...
        [HttpPost]
        public string AtualizaEstadoSav(NfiEncomendas.WebServer.Areas.POS.ViewModels.EstadoSav.EstadoSav EstadoEncomenda)
        {
