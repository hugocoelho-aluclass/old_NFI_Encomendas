...
namespace NfiEncomendas.WebServer.Areas.POS.Controllers
{
    public class AdminOperadoresController : ApiController
    {
        ...
        [HttpPost]
        public string AtualizaOperador(NfiEncomendas.WebServer.Areas.POS.ViewModels.Admin.Operador op)
        {
        ...
        [HttpPost]
        public string AtualizaOperadorPassword(NfiEncomendas.WebServer.Areas.POS.ViewModels.Admin.PagGestaoOperadoresAtualizaPassword op)
        {
            BusinessLogic.AdminUtilizadoresBL bl = new BusinessLogic.AdminUtilizadoresBL();
