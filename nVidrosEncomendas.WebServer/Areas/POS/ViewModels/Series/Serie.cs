namespace NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Series
{
    public class Serie
    {
        ...
        {
            Models.Series res = (new NVidrosEncomendas.WebServer.BusinessLogic.SeriesBL()).LerSerie(this.NumSerie); //new Models.Operadores();
