namespace NVidrosEncomendas.WebServer.Areas.POS.ViewModels.TipoAvarias
{
    public class TipoAvaria
    {
        ...
        {
            Models.TipoAvarias res = (new NVidrosEncomendas.WebServer.BusinessLogic.TipoAvariasBL()).LerTipoAvaria(this.NumTipoAvaria); //new Models.Operadores();
