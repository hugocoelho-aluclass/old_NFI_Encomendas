...
namespace NVidrosEncomendas.WebServer.Areas.POS.ViewModels.SetoresEncomenda
{
    public class SetorEncomenda
    {
        ...
        {
            Models.SetorEncomendas res = (new NVidrosEncomendas.WebServer.BusinessLogic.SetorEncomendasBL()).LerSetor(this.NumSetor);
            res.Nome = this.Nome;
