namespace NVidrosEncomendas.WebServer.Areas.POS.ViewModels.EstadoRecolha
{
    public class EstadoRecolha
    {
        ...
        {
            Models.EstadoRecolha res = (new NVidrosEncomendas.WebServer.BusinessLogic.EstadoRecolhaBL()).Ler(this.Id);
