...
namespace NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Admin
{
    public class Operador
    {
        ...
        {
            NVidrosEncomendas.WebServer.BusinessLogic.AdminUtilizadoresBL admBl = new NVidrosEncomendas.WebServer.BusinessLogic.AdminUtilizadoresBL();
            NVidrosEncomendas.WebServer.BusinessLogic.DepartamentoSavsBL depSavsBl = new BusinessLogic.DepartamentoSavsBL(admBl.DbContext);
