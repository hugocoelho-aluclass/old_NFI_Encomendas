namespace NVidrosEncomendas.WebServer.Areas.POS.ViewModels.EstadoSav
{
    public class EstadoSav
    {
        ...
        {
            Models.EstadoSav res = (new NVidrosEncomendas.WebServer.BusinessLogic.EstadoSavBL()).LerEstadoSav(this.NumEstadoSav); //new Models.Operadores();
