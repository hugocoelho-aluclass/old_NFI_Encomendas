...
namespace NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Setores
{
    public class Setor
    {
        public Setor()
        ...
        {
            Models.Setor res = (new NVidrosEncomendas.WebServer.BusinessLogic.SetorBL()).LerSetor(this.NumSetor);
            res.Nome = this.Nome;
