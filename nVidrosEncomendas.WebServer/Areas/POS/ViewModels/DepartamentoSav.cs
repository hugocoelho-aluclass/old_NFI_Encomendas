namespace NVidrosEncomendas.WebServer.Areas.POS.ViewModels.DepartamentoSavs
{
    public class DepartamentoSav
    {
        ...
        {
            Models.DepartamentoSav res = (new NVidrosEncomendas.WebServer.BusinessLogic.DepartamentoSavsBL()).LerDepartamentoSav(this.NumDepartamentoSav); //new Models.Operadores();
