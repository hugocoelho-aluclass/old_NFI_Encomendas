...
namespace NVidrosEncomendas.WebServer.Areas.POS.Controllers
{
    ...
    {
        [HttpGet]
        public List<NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Series.Serie> TabelaSeries()
        {
        ...
        [HttpPost]
        public string AtualizaSerie(NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Series.Serie Serie)
        {
