...
using NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Savs;
...
namespace NVidrosEncomendas.WebServer.Areas.POS.Controllers
{
    ...
    {
        [HttpGet]
        public List<NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Savs.Savs> TabelaSavs()
        {
        ...
        public ViewModels.Savs.PagEditSav EditSav(int id = 0)
        {
            ...
            NVidrosEncomendas.WebServer.Models.Savs enc = BlRes.Key;
