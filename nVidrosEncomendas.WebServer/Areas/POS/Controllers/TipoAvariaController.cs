...
namespace NVidrosEncomendas.WebServer.Areas.POS.Controllers
{
    ...
    {
        [HttpGet]
        public List<NVidrosEncomendas.WebServer.Areas.POS.ViewModels.TipoAvarias.TipoAvaria> TabelaTipoAvaria()
        {
        ...
        [HttpPost]
        public string AtualizaTipoAvaria(NVidrosEncomendas.WebServer.Areas.POS.ViewModels.TipoAvarias.TipoAvaria TipoAvaria)
        {
