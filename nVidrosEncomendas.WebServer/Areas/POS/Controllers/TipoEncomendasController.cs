...
namespace NVidrosEncomendas.WebServer.Areas.POS.Controllers
{
    ...
    {
        [HttpGet]
        public List<NVidrosEncomendas.WebServer.Areas.POS.ViewModels.TipoEncomendas.TipoEncomenda> TabelaTipoEncomenda()
        {
        ...
        [HttpPost]
        public string AtualizaTipoEncomenda(NVidrosEncomendas.WebServer.Areas.POS.ViewModels.TipoEncomendas.TipoEncomenda TipoEncomenda)
        {
