...
namespace NVidrosEncomendas.WebServer.Areas.POS.Controllers
{
    ...
    {
        [HttpGet]
        public List<NVidrosEncomendas.WebServer.Areas.POS.ViewModels.SetoresEncomenda.SetorEncomenda> TabelaSetores()
        {
        ...
        [HttpPost]
        public string AtualizaSetor(NVidrosEncomendas.WebServer.Areas.POS.ViewModels.SetoresEncomenda.SetorEncomenda setorEncomenda)
        {
