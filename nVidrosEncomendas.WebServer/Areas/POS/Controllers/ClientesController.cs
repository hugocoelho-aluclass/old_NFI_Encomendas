...
namespace NVidrosEncomendas.WebServer.Areas.POS.Controllers
{
    ...
    {
        [HttpGet]
        public List<NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Clientes.Cliente> TabelaClientes()
        {
        ...
        [HttpPost]
        public string AtualizaCliente(NVidrosEncomendas.WebServer.Areas.POS.ViewModels.Clientes.Cliente cliente)
        {
