...
namespace NVidrosEncomendas.WebServer.Areas.POS.Controllers
{
    ...
    {
        [HttpGet]
        public List<NVidrosEncomendas.WebServer.Areas.POS.ViewModels.EstadoRecolha.EstadoRecolha> TabelaEstadoRecolha()
        {
        ...
        [HttpPost]
        public string AtualizaEstadoRecolha(NVidrosEncomendas.WebServer.Areas.POS.ViewModels.EstadoRecolha.EstadoRecolha EstadoRecolha)
        {
